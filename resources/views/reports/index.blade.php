...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div class="bg-white rounded-xl border border-slate-200 p-4">
            <p class="text-sm text-slate-500">Total Kilos</p>
            <p class="text-2xl font-bold text-slate-800">{{ number_format($summary['total_kilos'], 2) }}</p>
        </div>
        <div class="bg-white rounded-xl border border-slate-200 p-4">
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse($orders as $order)
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 text-right text-slate-600">{{ number_format($order->total_kilos, 2) }}</td>
