...
@section('page-description', 'Update business details')

@section('content')
<div class="max-w-2xl">
    <div class="bg-white rounded-xl border border-slate-200 p-6">
        <form action="{{ route('super-admin.businesses.update', $business) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center gap-3">
                <input
                    ...
                    class="w-4 h-4 text-teal-500 border-slate-300 rounded focus:ring-teal-400"
                >
