        ...
        <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input 
                    ...
                    placeholder="e.g., Laundry Detergent, Fabric Conditioner"
                >
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="quantity" class="block text-sm font-medium text-slate-700 mb-2">Initial Stock *</label>
                    <input 
                        type="number" 
                        id="quantity" 
                        name="quantity" 
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none"
                    >
                    <p class="mt-1 text-xs text-slate-500">Alert when stock falls below this amount</p>
